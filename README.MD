...
#### Response
    ...
    new Subway\Response()
        ...
        ->sendText(string $data) : void // send text/html content
        ->sendJSON(array $data) : void // send json encoded from array
